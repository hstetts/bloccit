  ...
  describe 'GET #edit' do
    ...
    describe 'POST create' do
      it 'increased the number of Sponsored Post by 1' do
        expect {
          post :create, params: {
            topic_id: my_topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_integer } }
    ...
    describe 'PUT update' do
      it 'updates sponsored post with expected attributes' do
        ...
        put :update, params: {
          topic_id: my_topic.id, id: sponsored_post.id, sponsored_post: { title: new_title, body: new_body, price: new_price }
        }
